...
document.querySelectorAll('input[name="dayType"]').forEach((item) => {
  item.addEventListener("change", () => updateFieldVisibility(item.value));
});

document.querySelectorAll('input[name="userType"]').forEach((item) => {
  item.addEventListener("change", () => updateSchoolLabels(item.value));
});

document.querySelectorAll('input[name="hasActivity"]').forEach((item) => {
...
document.addEventListener("DOMContentLoaded", () => {
  updateFieldVisibility(document.querySelector('input[name="dayType"]:checked').value);
  updateSchoolLabels(document.querySelector('input[name="userType"]:checked').value);
  updateActivityVisibility(document.querySelector('input[name="hasActivity"]:checked').value);
});
